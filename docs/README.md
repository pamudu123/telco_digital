# Company Intelligence POC — documentation
...
| [SHARED-INTELLIGENCE.md](./SHARED-INTELLIGENCE.md) | How this POC supports company shared intelligence across applications |
...
| [POC-UI.md](./POC-UI.md) | Intelligence Showcase UI for the existing company/NG applications |
| [EXISTING-APP.md](./EXISTING-APP.md) | Mapping from shared-intelligence capabilities to existing company applications |
