...
Outcome recording and command writes are not implemented. Graph fraud, SFA
forecasting and digital twins are live as separate panels; this engine does
not consume them. FastAPI-complete and the simulator stay not started.

## 11. POC limitations

Rules are persona-shaped. Capabilities 07–09 are separate live panels; this
engine composes 03–06 only. The catalogue and journeys are synthetic.
