...
const PLANNED = {
  models: {
    ...
    body: "Churn and graph-fraud scores are live on Customer 360. Travel recommendations are live on Journey. SFA forecasts are live on Retail and SFA. Twins and the decision engine are not started. This page does not display those later scores.",
  },
  copilot: {
    title: "Copilot",
...
function renderShell(root) {
  ...
  root.replaceChildren(
    ...
    el("div", { className: "banner", role: "note" }, [
      ...
      el("span", {
        text: "All customer records are synthetic POC fixtures. Capabilities 00–08 are a read-only POC showcase — not production, not FastAPI complete, and not the simulator.",
      }),
    ]),
    el("div", { className: "app-shell" }, [
      ...
      el("aside", { className: "sidebar" }, [
        ...
        el("div", { className: "sidebar-foot" }, [
          el("div", { text: "POC environment: Live evidence = capabilities 00–08." }),
  ...
  root.replaceChildren(
    el("div", { className: "page-header" }, [
      el("div", {}, [
        ...
        el("p", { text: "Live facts, Neo4j projection, point-in-time features, travel event memory, catalogue recommendations, graph fraud scores and SFA forecasts. Later capabilities are labeled as planned." }),
      ]),
    ...
    root.replaceChildren(
      ...
      el("section", { className: "card" }, [
        ...
        el(
          "div",
          { className: "stepper" },
          manifest.capabilities.slice(0, 9).map((capability) => {
