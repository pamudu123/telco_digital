...
const PLANNED = {
  models: {
    ...
    body: "Churn scores and computed twins are live on Customer 360. Travel recommendations are live on Journey. Graph fraud, SFA forecasting and the decision engine are not started. This page does not display those later scores.",
  },
  copilot: {
    title: "Copilot",
...
function renderShell(root) {
  ...
  root.replaceChildren(
    ...
    el("div", { className: "banner", role: "note" }, [
      ...
      el("span", {
        text: "All customer records are synthetic POC fixtures. Capabilities 00–06 and 09 are a read-only POC showcase — not production, not FastAPI complete, and not the simulator.",
      }),
    ]),
    el("div", { className: "app-shell" }, [
      ...
      el("aside", { className: "sidebar" }, [
        ...
        el("div", { className: "sidebar-foot" }, [
          el("div", { text: "POC environment: Live evidence = capabilities 00–06 and 09." }),
  ...
  root.replaceChildren(
    el("div", { className: "page-header" }, [
      el("div", {}, [
        ...
        el("p", { text: "Live facts, Neo4j projection, point-in-time features, travel event memory and computed twins. Later capabilities are labeled as planned." }),
      ]),
