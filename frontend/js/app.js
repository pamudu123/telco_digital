...
const PLANNED = {
  models: {
    ...
    body: "Churn scores are live on Customer 360. Travel recommendations are live on Journey. SFA forecasts are live on Retail and SFA. Twins and the decision engine are not started. This page does not display those later scores.",
  },
  copilot: {
    title: "Copilot",
...
function renderShell(root) {
  ...
  root.replaceChildren(
    ...
    el("div", { className: "banner", role: "note" }, [
      ...
      el("span", {
        text: "All customer records are synthetic POC fixtures. Capabilities 00–06 and 08 are a read-only POC showcase — not production, not FastAPI complete, and not the simulator.",
      }),
    ]),
    el("div", { className: "app-shell" }, [
      ...
      el("aside", { className: "sidebar" }, [
        ...
        el("div", { className: "sidebar-foot" }, [
          el("div", { text: "POC environment: Live evidence = capabilities 00–06 and 08." }),
