  ...
  root.replaceChildren(
    el("div", { className: "page-header" }, [
      el("div", {}, [
        ...
        el("p", {
          text: "Live next-best actions from the decision engine. Digital twins remain POC planned and are not scored here.",
        }),
      ]),
  ...
  try {
    ...
    results.replaceChildren(
      ...
      el("section", { className: "card" }, [
        el("header", {}, [el("h3", { text: "Digital twins" }), badge("POC planned", "planned")]),
        el("p", {
          text: "A computed digital twin is not started on this branch. Twin scores are not invented here.",
        }),
      ]),
    );
  } catch (error) {
